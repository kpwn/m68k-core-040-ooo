...
object GenFullCoreSynthVerilog {
  ...
  def buildWith(dbgBuildId: BigInt, vioEnable: Boolean, outputName: String,
                ...
                detachedStoreEntries: Int = 1): Unit = {
    val p = M68kParams()
