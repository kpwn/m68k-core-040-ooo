...
object DebugRegMap {
  ...
  val OFF_PCRANGE_PC0: Int = 0x00130
  ...
  val OFF_MULTIHOT_STATUS: Int = 0x01030
  val OFF_MULTIHOT_IC: Int = 0x01034
  val OFF_MULTIHOT_DCLOAD: Int = 0x01038
  val OFF_MULTIHOT_DCPROBE: Int = 0x0103C
  ...
  val OFF_PERF_DETAIL_CAP: Int = 0x010B4
  val OFF_PERF_DETAIL_BASE: Int = 0x01100
  ...
  val allOffsets: Seq[(String, Int)] = Seq(
    ...
    ("OFF_PERF_DETAIL_CAP", 0x010B4),
    ("OFF_PERF_DETAIL_BASE", 0x01100),
