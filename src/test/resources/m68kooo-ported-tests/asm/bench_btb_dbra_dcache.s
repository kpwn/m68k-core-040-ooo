| bench_btb_dbra_dcache.s — D-CACHE-ENABLED variant of bench_btb_dbra.s
|
| Generated from tb/tests/asm/bench_btb_dbra.s by prepending the D-cache-enable
| prologue below.  The workload itself is byte-identical to the parent,
| so (bench_btb_dbra, bench_btb_dbra_dcache) is a like-for-like
