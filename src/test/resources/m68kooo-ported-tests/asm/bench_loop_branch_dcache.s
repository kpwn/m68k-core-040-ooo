| bench_loop_branch_dcache.s — D-CACHE-ENABLED variant of bench_loop_branch.s
|
| Generated from tb/tests/asm/bench_loop_branch.s by prepending the D-cache-enable
| prologue below.  The workload itself is byte-identical to the parent,
| so (bench_loop_branch, bench_loop_branch_dcache) is a like-for-like
