| bench_dep_chain_dcache.s — D-CACHE-ENABLED variant of bench_dep_chain.s
|
| Generated from tb/tests/asm/bench_dep_chain.s by prepending the D-cache-enable
| prologue below.  The workload itself is byte-identical to the parent,
| so (bench_dep_chain, bench_dep_chain_dcache) is a like-for-like
