| bench_dc_prologue_cal_dcache.s — D-CACHE-ENABLED variant of bench_dc_prologue_cal.s
|
| Generated from tb/tests/asm/bench_dc_prologue_cal.s by prepending the D-cache-enable
| prologue below.  The workload itself is byte-identical to the parent,
| so (bench_dc_prologue_cal, bench_dc_prologue_cal_dcache) is a like-for-like
